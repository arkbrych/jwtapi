package pl.brych.jwtapi.filter;
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    public static final String pass = "A?D(G+KbPdSgVkYp3s6v9y$B&E)H@McQfThWmZq4t7w!z%C*F-JaNdRgUkXn2r5u";
    ...
    private UsernamePasswordAuthenticationToken getUsernamePasswordAuthenticationToken(String authorization) {
        JWTVerifier jwtVerifier = JWT.require(Algorithm.HMAC512(pass)).build();
